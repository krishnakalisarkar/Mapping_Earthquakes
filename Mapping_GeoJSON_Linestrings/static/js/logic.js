...
//});
//---------------------------------------------------------------
 // We create the tile layer that will be the background of our map. Skill Drill 13.5.5
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJson(data,{
      ...
      onEachFeature: function(feature,layer){
          console.log(layer);
          layer.bindPopup("<h3>Airline Code : " + feature.properties.airline + "</h3><hr> <h3>Destination Name : " + feature.properties.dst + "</h3>");
      }
  }).addTo(map);
});
